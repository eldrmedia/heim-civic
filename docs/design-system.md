...
Phase 3 implements the representative summary molecule, representative-results organism, party label atom, and official-profile template. Phase 4 adds the bill-card molecule and bill-page template. Phase 5 adds the finance-overview molecule and finance-page template. Phase 6 adds search-result and correction-form organisms. Phase 7 adds the district-boundary-map molecule and district-page template. Phase 8 adds the waitlist-form organism and trust-disclosure content patterns. Phase 9 adds textual source-health states with redundant labels, icons, and color. Phase 9.1 adds bill-index cards and a server-rendered, paginated bill-directory organism with explicit index-only and enhanced labels. Phase 9.2 adds the enhanced-bill-selection-log organism, progress cards, and review-state badges; queued and published records remain textually distinct. Party, vote, finance, map, coverage, review, and operational values are always written in text; neutral brand color does not imply partisan meaning. Finance categories use accessible tables rather than color-only charts.
