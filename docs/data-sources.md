...
The normalized boundary artifact is generated by `npm run data:boundaries` from `data/sources/nevada-boundaries-2021.manifest.json`. Generation fails on checksum, feature-count, district-sequence, geometry-type, or Nevada-coordinate-bound changes. See decision record `0002-geographic-boundary-pipeline.md`.
